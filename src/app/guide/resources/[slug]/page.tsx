...
const resourceMeta: Record<string, {
  ...
  "superpowers": {
    ...
    name: "Superpowers — Khung kỹ năng Agent hoàn chỉnh",
    category: "Skill",
    iconName: "Sparkles",
    ...
    overview: "Khung kỹ năng hoàn chỉnh cho coding agent. Không phải tool, mà là bộ quy trình giúp Agent tự biết khi nào cần hỏi, khi nào cần plan, khi nào cần verify. Hoạt động trên Claude Code, Cursor, Codex, Gemini, Copilot. 161k stars trên GitHub.",
    highlights: [
      "Brainstorming: Agent hỏi trước khi làm — tránh sai scope từ đầu",
      "TDD RED-GREEN-REFACTOR: Viết test trước, code sau, không bao giờ ngược lại",
      "Verification: Không claim thành công khi chưa chạy verification command",
      "Systematic Debugging: Root cause 4 giai đoạn — không đoán mò",
      "Subagent-Driven Development: Nhiều agent con cùng làm, review 2 giai đoạn",
      "Writing Plans: Task nhỏ 2-5 phút, mỗi task có file path + code + verification",
    ],
    usage: [
      "Cài đặt Superpowers plugin vào tool bạn đang dùng (Cursor, Claude Code...)",
      "Agent sẽ tự trigger đúng skill khi cần — không cần gõ lệnh",
      "Kết hợp với các quy tắc code và quy trình để đạt hiệu quả cao nhất",
      "Skills trigger tự động: brainstorming khi xây dựng feature mới, TDD khi viết code",
    ],
    usageSteps: [
      "Chọn tool bạn đang dùng (Cursor, Claude Code, Codex...)",
      "Cài đặt Superpowers theo hướng dẫn trong file",
      "Agent tự động trigger skills phù hợp với từng tình huống",
      "Khi phát hiện bug: Agent tự trigger systematic-debugging",
      "Khi xây dựng feature mới: Agent tự trigger brainstorming trước",
      "Khi viết code: Agent tự trigger TDD — test trước, code sau",
      "Khi gần hoàn thành: Agent tự trigger verification-before-completion",
    ],
  },
};
